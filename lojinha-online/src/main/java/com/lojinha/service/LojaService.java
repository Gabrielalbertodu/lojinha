...
public class LojaService {
    ...
    public Pedido criarPedido(Cliente cliente, List<ItemPedido> itens) {
        ...
        System.out.println("[LOJA] Pedido #" + pedido.getId() +
                " criado para o cliente " + cliente.getNome());

        return pedido;
    }

    public ItemPedido criarItem(Produto produto, int quantidade) {
        return new ItemPedido(proximoItemId++, produto, quantidade);
    }
